...
* [[max-len]](https://eslint.org/docs/rules/max-len) | WARN | Line lengths may not exceed 120 characters, with exceptions provided for URLs, strings, and template literals.
